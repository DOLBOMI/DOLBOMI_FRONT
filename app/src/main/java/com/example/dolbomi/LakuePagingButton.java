...
public class LakuePagingButton extends LinearLayout {
    ...
    public void addBottomPageButton(int listsize, int nowpage) {
        ...
        switch (divisionPageType.pageType(startpage+1,listsize,MAX_PAGE)){
            case PagingDefine.ADD_PAGE_TYPE_FIRST:
                Log.i("PAGELIST", "ADD_PAGE_TYPE_FIRST");
                for (int i = startpage; i < lastpage; i++) {
                    textView = new TextView(context);
                    setText(textView,i);

                    createButton(textView,i,startpage,lastpage,PagingDefine.ADD_PAGE_TYPE_FIRST);
                ...
                break;
            case PagingDefine.ADD_PAGE_TYPE_FIRST_NEXT:
                Log.i("PAGELIST", "ADD_PAGE_TYPE_FIRST_NEXT");
                for (int i = startpage; i < lastpage+1; i++) {
                    textView = new TextView(context);
                    setText(textView,i);

                    createButton(textView,i,startpage,lastpage,PagingDefine.ADD_PAGE_TYPE_FIRST_NEXT);
                ...
                break;
            case PagingDefine.ADD_PAGE_TYPE_CENTER:
                Log.i("PAGELIST", "ADD_PAGE_TYPE_CENTER");
                for (int i = startpage-1; i < lastpage+1; i++) {
                    textView = new TextView(context);

                    setText(textView,i);
                    createButton(textView,i,startpage,lastpage,PagingDefine.ADD_PAGE_TYPE_CENTER);
                ...
                break;
            case PagingDefine.ADD_PAGE_TYPE_LAST_BEFORE:
                ...
                for (int i = startpage-1; i < lastpage; i++) {
                    ...
                    createButton(textView,i,startpage,lastpage,PagingDefine.ADD_PAGE_TYPE_LAST_BEFORE);
