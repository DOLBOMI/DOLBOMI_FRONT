...
public class StepCheckService extends Service implements SensorEventListener {
    ...
    int count = com.example.dolbomi.StepValue.Step;
    ...
    public void onDestroy() {
        ...
        if (sensorManager != null) {
            ...
            com.example.dolbomi.StepValue.Step = 0;
        } // end of if
    } // end of onDestroy
        ...
        if (event.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
            ...
            if (gabOfTime > 100) { //  gap of time of step count
                ...
                if (speed > SHAKE_THRESHOLD) {
                    ...
                    com.example.dolbomi.StepValue.Step = count++;

                    String msg = com.example.dolbomi.StepValue.Step / 2 + "";
